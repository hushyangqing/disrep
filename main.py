...
parser.add_argument('--dataset', default='flatland', type=str, choices=['flatland', 'dsprites'])
parser.add_argument('--iid', default=False, type=ast.literal_eval, help='only for flatland')
